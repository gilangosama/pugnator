<x-app-layout>
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="text-gray-600 mb-4">
                                    <p class="mb-1"><i class="fas fa-calendar mr-2"></i>{{ $event['date'] }}</p>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="{{ route('events.show', 1) }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                                        Daftar
                                    </a>
                                </div>
                            </div>
            ...
            <!-- Ongoing dan Completed sections serupa -->
        </div>
    </div>
